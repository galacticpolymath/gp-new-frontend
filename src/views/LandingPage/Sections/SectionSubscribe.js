...
const style = {
  ...
  subscribeContainer: {
    ...
    boxShadow: "inset 4vw -2vw 10vw 3px rgba(108,45,130,.2), " + //light purple inset
...
export default function SectionSubscribe() {
  ...
  return (
    <>
      ...
      <GridItem  xs={12} sm={4} md={6} lg={5} className={classNames(classes.buttonContainer,classes.centerAlign) }>
