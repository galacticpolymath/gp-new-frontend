  ...
  return (
    <div className={classes.featuresSection}>
        ...
        description={
          <span>Built using
            ...
            <ul>
              ...
              <li>
                <span>Social Studies – <a href={"https://www.nextgenscience.org/"}>College, Career, and Civic Life Framework (C3)</a></span>
              </li>
            </ul>
          </span>
        }
      ...
      <FeatureDetails
        ...
        description={"As we said, the goal is 15 minutes or less of prep even for teachers with new training in the content. We do " +
