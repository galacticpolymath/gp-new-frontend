      ...
      <GridContainer className={classes.valuePropsGridContainer}>
        ...
        <GridItem>
          <InfoArea
            ...
            description={
              "Our lessons improve learning and retention by imbuing rigorous, interdisciplinary lessons " +
        ...
        <GridItem>
          <InfoArea
            ...
            description={
              "We will aggregate impact reports to showcase the good you are doing in " +
